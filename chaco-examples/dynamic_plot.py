...
# -*- coding: utf-8 -*-
"""
This example shows how to make a plot with display attributes that can be
dynamically modified by other interface components.

Relevant tutorial section:
http://docs.enthought.com/chaco/user_manual/chaco_tutorial.html#dynamically-changing-plots
"""
